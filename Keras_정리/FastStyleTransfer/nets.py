...
from tensorflow.keras.layers import Layer, add, InputSpec, Activation, BatchNormalization, Conv2D, UpSampling2D, Cropping2D, concatenate, Input
...
def loss_net(x_in, trux_x_in, width, height, style_image_path, content_weight, style_weight):
    ...
    vgg = VGG16(include_top=False, input=x)
